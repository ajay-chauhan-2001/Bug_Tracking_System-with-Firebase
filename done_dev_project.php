          ...
          <!-- <a href="add_developer1.php">Add New Developer</a> -->
            ...
            <tbody>
                ...
                <?php
                  ...
                  $sql="SELECT * FROM developer_project WHERE status='sucess'";
                  $result = mysqli_query($db,$sql);
                      ...
                      if ($result->num_rows > 0) {
                          ...
                          { 
                            ...
                            $res="select * from developer where id= '$dev_id' where active = 1";
                            $ad="select * from admin where id= '$ad_id' where active = 1";

                            $bug="select * from bugs where project_id= '$bug_id' where active = 1";
