        ...
        <div class="card-body">
          <div class="table-responsive">
           ...
           <?php if ($_SESSION['role'] == 'admin') : ?>
            ...
            <button type="submit" class="btn btn-primary my-3" name="submit"><a href="add_developer_project.php" class="text-white"><i class="fa fa-plus"></i>Add Developer Project</a>    
            </button>
            <?php endif; ?>
        ...
        <!-- <a href="add_developer1.php">Add New Developer</a> -->
          ...
          <thead>
            <tr>
              ...
              <th scope="col" style="width: 500px;">Bug Name</th>
          ...
          <?php
            ...
            $sql="select * from developer_project where active=1";
            $result = mysqli_query($db,$sql);
                ...
                if ($result->num_rows > 0) {
                    ...
                    { 
                      ...
                      $ad="select * from admin where id= '$ad_id' and  active=1";

                      $bug="select * from bugs where project_id= '$bug_id' and active=1";
                      $tes_comment="select * from tester_project where id= '$comment_tes' and active=1";
                      $status_sql="select * from tester_project where id= '$status' and  active=1";


                      // $status_sql="SELECT developer_project.status as tes FROM tester_project JOIN developer_project ON tester_project.id = developer_project.id and active=1";

        //               $status_sql="SELECT developer_project.status as tes FROM tester_project JOIN developer_project ON tester_project.id = developer_project.id';
        // "
        //               //  SELECT status FROM tester_project
                      // INNER JOIN developer_project ON tester_project.id = developer_project.id;

                      // SELECT developer_project.status, tester_project.status   FROM tester_project  
        // INNER JOIN developer_project ON tester_project.id = developer_project.id  
        // ORDER BY order_id;  
                      ...
                      ?>
                        <tr>
                            ...
                            <td>
                             ...
                             <td>
                                <a href="edit_developer_project.php?id=<?php echo $row['id']; ?>"style="color: #3260cb !important;"><i class="fa fa-edit"></i></a>
                                <?php if ($_SESSION['role'] == 'admin') : ?>

                                <a href="delete_developer_project.php?id=<?php echo $row['id']; ?>"style="color: #3260cb !important;"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                <?php endif; ?>
