    ...
    <div class="card shadow mb-4">   
        <div class="card-body">
          <div class="table-responsive">
           ...
           <a href="add_tester_project.php" class="text-white"><i class="fa fa-plus"></i>Add Tester Project</a>    
           </button>
           <?php endif; ?>
            ...
            <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width=" 100%">
                ...
                <tbody>
                  ...
                  <?php
                    ...
                    $sql="SELECT * FROM tester_project WHERE status='sucess'";
                            ...
                            { 
                              ...
                              ?>
                                <tr>
                                    ...
                                    <td>
                                          <?php foreach ($dev_query as $val) {echo $val['tester_comment']; }  ?>
                                    </td>
